...
public class SysUserServiceImpl implements ISysUserService
{
    ...
    {
        this.insertUserRole(user.getUserId(), user.getRoleIds(),user);
    }
     ...
     * @param roleIds 角色组
     */
    public void insertUserRole(Long userId, Long[] roleIds,SysUser user)
    {
        Long roleIdOfUser = null;
        if (StringUtils.isNotEmpty(roleIds))
        {
             ...
             * 对角色的ID进行判断然后注册区块链账户
             */
            if (roleIdOfUser != null) {
                UserKey blockChainUser = userKeyService.createBlockChainUser();
                // 角色ID为100注册为机构账户
                if (String.valueOf(roleIdOfUser).equals("100")) {
                    Org org = new Org();
                ...
                //角色ID为101的注册为物流商机构
                if (String.valueOf(roleIdOfUser).equals("101")) {
