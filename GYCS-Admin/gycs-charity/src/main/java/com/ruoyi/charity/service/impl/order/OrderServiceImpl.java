package com.ruoyi.charity.service.impl.order;
...
public class OrderServiceImpl implements OrderService {
    ...
    public AjaxResult endOrderById(Integer orderId) {
        ...
        BigInteger traceId = charityOrder.getTraceId();
        ActiviteTrace activiteTrace = mpActivityTraceMapper
                .selectOne(Wrappers.lambdaQuery(ActiviteTrace.class).eq(ActiviteTrace::getCharityId, traceId));
        activiteTrace.setIsSign(true);
        mpActivityTraceMapper.updateById(activiteTrace);
