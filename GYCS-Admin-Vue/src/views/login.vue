    ...
    <div class="container" style="margin-right: 8%">
      <div class="left">
        <el-form class="form" ref="loginRef" :model="loginForm" :rules="loginRules">
          <h3 style="margin-left: 40px;">SZPU-SZGY-Admin</h3>
          <div class="input-block" style="margin-top: 20px">
            <el-form-item prop="username">
              <input class="input" type="text" id="email" required="" v-model="loginForm.username">
              <label for="email">用户名</label>
            </el-form-item>
          </div>
          <div class="input-block">
            <el-form-item prop="password">
              <input class="input" type="password" id="pass" required="" v-model="loginForm.password">
            ...
            <el-form-item prop="code" v-if="captchaEnabled">
              <div style="margin-left: 14px">
                <input
                    ...
                    required=""
                />
                <label for="code" style="margin-left: 16px">验证码</label>
              </div>
            </el-form-item>
            <div class="login-code" style="margin-right: 20px;margin-top: 14px">
  ...
  proxy.$refs.loginRef.validate(valid => {
    if (valid) {
      ...
      userStore.login(loginForm.value).then(() => {
        ...
        ElNotification({
          title: '登录成功',
          message: h('i', { style: 'color: teal' }, '欢迎回来,' + loginForm.value.username),
        })
      }).catch(() => {
        loading.value = false;
        // 重新获取验证码
