...
function handleLogin() {
  if (loginForm.value.userAddress == "") {
    if (loginForm.value.password == "" || loginForm.value.username == "") {
      openNotification("danger","系统通知","账户信息不能为空")
      return
    }
  }
  // 调用action的登录方法
          ...
          <div class="form_container wow fadeInUp" data-wow-delay=".4s">
            ...
            <div v-if="active == 1" style="width: 100%;">
              ...
              <div class="input_container wow fadeInLeft" data-wow-delay=".2s">
                ...
                <input placeholder="密码" title="Inpit title" name="input-name" type="password" class="input_field" id="password_field" v-model="loginForm.password"  @keydown.enter="handleLogin">
              </div>
            </div>
            <div v-if="active == 2" style="width: 100%;margin-bottom: 20px">
              <div class="input_container wow fadeInLeft"  data-wow-delay=".2s">
                ...
                <input placeholder="区块链账户地址" title="Inpit title" name="input-name" type="text" class="input_field" id="email_field" v-model="loginForm.userAddress" @keydown.enter="handleLogin">
              </div>
            </div>
