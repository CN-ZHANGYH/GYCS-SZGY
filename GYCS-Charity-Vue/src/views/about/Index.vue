...
<!--            <a href="#0" class="nav-close"><i class="fal fa-times"></i></a>-->
      ...
      <div class="row justify-content-center">
        <div class="col-xl-6 col-md-10 wow fadeInUp" data-wow-delay="0.3s">
          <div class="section-head text-center">
            <h2 class="title">我们的开发团队</h2>
            <p class="text">Our team is responsible for the development of a blockchain based public welfare charity traceability platform project, which includes architecture design, architecture business implementation, and product deployment and application.
            </p>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
          <div class="team-box">
            ...
            <div class="content">
              <h4 class="lasthead">张宇豪</h4>
              <p class="ceo">全栈开发 & 运维合约</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
          <div class="team-box">
            ...
            <div class="content">
              <h4 class="lasthead">陈梓康</h4>
              <p class="ceo">合约安全 & 底层开发</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
          <div class="team-box">
            ...
            <div class="content">
              <h4 class="lasthead">钟文慧</h4>
              <p class="ceo">前端 & UI设计</p>
            </div>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
          <div class="team-box">
            ...
            <div class="content">
              <h4 class="lasthead">陈淑真</h4>
              <p class="ceo">前端 & 运维部署</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row justify-content-between">
        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
          <div class="footer-box one">
            <div class="logo">
              <img src="../../assets/picture/logo-2.png" alt="Markpro">
            </div>
  ...
  <div class="back-to-top">
    <a href="#" style="padding: 5px;border-radius: 50px">
